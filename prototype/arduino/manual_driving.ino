...
const int wheelFrontRightPin1 = 12;
const int wheelFrontRightPin2 = 13;
const int wheelFrontRightPinPWM = 3;
...
void loop() {
  ...
  if (Serial.available()){
    ...
    } else if (command.equals("WHEEL_RIGHT")) {
      command = Serial.readStringUntil(';');
